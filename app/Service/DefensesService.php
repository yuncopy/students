...
use App\Model\DefensesModel;
use App\Service\StudentService;
use App\Service\SemesterService;

class DefensesService extends CommonService{
    ...
    public static function insertData($data){
        if(is_array($data) && $data){
            return (new DefensesModel)->insertOrUpdate($data);
        }
        return false;
    }
    ...
    public static function uniqueData($key,$val){
        if($key && $val){
            return (new DefensesModel)->getUniqueData($key,$val);
        }
        return false;
    }
    ...
    public static function DelOne($id){
        if($id){
            return (new DefensesModel())->delOne($id);
        }
        return false;
    }
    ...
    public static function updateData($data,$id){
        if(is_array($data) && $data && is_array($id)){
            return (new DefensesModel())->insertOrUpdate($data,$id);
        }
        return false;
    }
    ...
    public static function getOneData($id){
        return (new DefensesModel())->getUniqueData($id);
    }
